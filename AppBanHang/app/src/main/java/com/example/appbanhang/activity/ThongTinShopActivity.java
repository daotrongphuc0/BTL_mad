...
public class ThongTinShopActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        LatLng shopNDT = new LatLng(20.9911597,105.7722843);
        mMap.addMarker(new MarkerOptions().position(shopNDT).title("Shop PTIT").icon(BitmapDescriptorFactory.defaultMarker()));
